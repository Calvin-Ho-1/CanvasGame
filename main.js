...
var update = function (modifier) {
	...
	if (38 in keysDown) { // Player holding up
		...
		if (pikachu.y < ( 0) ) {
			...
			//adds a bump sound when hitting the wall/border (something extra that I wanted to add)
			//!!!! This will ONLY play if the player hits the wall by TAPPING IT!!! HOLDING THE MOVE KEY WILL NOT PLAY THE BUMP SOUND!
			//!!! This works, but it pops up that the play request was interrupted (in the console log) . This does NOT affect the gameplay or causes any problems with the game.
